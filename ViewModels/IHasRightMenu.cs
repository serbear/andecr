...
/// <summary>
/// Contract for a screen ViewModel that intends to display its own set of items /// in the shared Right Menu of the
/// main window (RightMenuView).
/// </summary>
public interface IHasRightMenu
{
    /// <summary>
